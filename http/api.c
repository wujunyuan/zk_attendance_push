...
#define BASE_URL "https://你的域名"

void releaseHttp(ft_http_client_t *);

int getSealBase64(char *sn, char **pOut, char *auth) {
    char *url = joinString(BASE_URL, "/api.php/attendance_post/post_attendance");
    cJSON *param = cJSON_CreateObject();
    cJSON_AddStringToObject(param, "data", sn);
    cJSON_AddStringToObject(param, "auth", auth);
